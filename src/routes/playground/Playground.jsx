            ...
            <div className="playgroundContent">
                <div className="playgroundInfoAndPendingContainer">
                    <div className="playgroundInformation">
                        <h3>
                            Welcome to <span className="highlight">Typathon!</span> App
                        </h3>
                        <p>
                            This form is designed to help you customize your typing test experience. By filling out the
                            form, you can select the language you want to practice, choose the duration of the test, and
                            pick your skill level. Whether you’re a beginner looking to improve your typing speed, an
                            intermediate user aiming to enhance your accuracy, or someone who enjoys typing out stories,
                            this form will tailor the test to your needs.
                        </p>
                    </div>
                ...
                <div className="playForm">
                    ...
                    <p>
                        <span className="highlight">Welcome!</span> Ready to take your typing skills to the next level?
                    ...
                    <Dropdown
                        var={storyRef}
                        options={dropdownStory.map((obj) => obj.title)}
                        legend="Story"
                        onClick={storyCollection}
                    />
