            ...
            <div className="supportContent">
                <InformationContainer>
                    ...
                    <p style={{ textIndent: '2em' }}>
                        Our support system is designed to assist you with any questions or issues you may encounter
                        while using our Typing Test Web App. Whether you need help with setting up your test,
                        understanding your results, or troubleshooting technical problems, our dedicated support team is
                        ready to provide you with prompt and effective assistance. Simply reach out to us through:{' '}
                    </p>
                    ...
                    <p style={{ textIndent: '2em' }}>
                        We’ll ensure you get the help you need to make the most of your typing practice. Nothing can be
                        your Obstactle to <span className="highlight">Learn, Grow and Earn!</span>
                    </p>
                </InformationContainer>
            </div>
        </>
