    ...
    return(
        <div className="registerContainer">
            <InformationContainer>
                ...
                to get notified for related news and contents.</p>
                <h2>STEP 02:</h2>
                <p>Say, <span className="highlight">Hi</span> to our official whatsapp number <span className="highlight">9709483986</span></p>
                <img width='50%' src={Hi} alt="hi" />

                <h2>STEP 03:</h2>
                <p>Agree our <span className="highlight">Terms and Condition</span>.</p>
