    ...
    return(
        <div className="footerContainer">
            <div className="about">
                ...
                <p>
                    Welcome to <span className="highlight">Typathon</span>, your go-to platform for enhancing your typing skills! Our mission is to provide an engaging and effective way for users of all levels to improve their typing speed and accuracy. Whether you’re a beginner just starting out or an experienced typist looking to refine your skills, our customizable tests and user-friendly interface make practice enjoyable and productive. Join us on your journey to becoming a <span className="highlight">typing pro!</span>
                </p>
            </div>
            ...
            <div className="lastRibbon">
                ...
                <span>
                <span>copyright @ 2024 </span><Hyperlink href={'www.typathon.com'} value="typathon.com"/></span>
            </div>
        </div>
    )
}
