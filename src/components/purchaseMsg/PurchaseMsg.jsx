    ...
    <PopUpContainer>
        <div className="purchaseMsgContainer">
            ...
            <div style={{display:'flex'}}>
                <Hyperlink style={{fontSize:'1.5em'}} type='bordered-theme' href='/pricing' value='View Plans' onClick={()=>setPurchaseBoxOpen(false)}/>
                <Button style={{width:'5em'}} transparancy={true} value='Leave' onClick={()=>setPurchaseBoxOpen(false)}/>
            </div>
        </div>
    </PopUpContainer>
    )
